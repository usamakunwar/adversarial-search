...
Match = namedtuple(
    "Match", "players initial_state time_limit match_id debug_flag")
...
def play_matches(custom_agent, test_agent, cli_args):
    ...
    if cli_args.fair_matches:
        ...
        results.extend(_run_matches(
            _matches, custom_agent.name, cli_args.processes))
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename="matches.log",
